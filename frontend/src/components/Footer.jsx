...
const Footer = () => {
  return (
    <div className="bg-black text-white mt-29">
      <div className="flex flex-wrap justify-evenly mb-29 pt-10">
        <div className="">
          <h2 className="font-semibold text-3xl mb-3">Exclusive</h2>
          <p className="mb-4 text-1xl">Subscribe</p>
          <p className=" mb-4 font-extralight">Get 10% off your first order</p>
          <form action="">
            <div className="flex border-1 border-white rounded-sm py-2 px-1.5">
              <input
        ...
        <div className="w-50">
          <h4 className="mb-4 text-1xl font-semibold">Support</h4>
          <p className="mb-3.5 font-extralight">
            111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.
          </p>
          <p className="mb-3.5 font-extralight">admin@exclusive.com</p>
          <p className="font-extralight">+88015-88888-9999</p>
        </div>
        <div className="">
          <h4 className="mb-4 text-1xl font-semibold">Account</h4>
          <ul>
            <li className="mb-4 font-extralight">My Account</li>
            <li className="mb-4 font-extralight">Login / Register</li>
            <li className="mb-4 font-extralight">Cart</li>
            <li className="mb-4 font-extralight">Wishlist</li>
            <li className="mb-4 font-extralight">Shop</li>
          </ul>
        </div>
        <div className="">
          <h4 className="mb-4 text-1xl font-semibold">Quick Link</h4>
          <ul>
            <li className="mb-4 font-extralight">Privacy</li>
            <li className="mb-4 font-extralight">Term of Use</li>
            <li className="mb-4 font-extralight">FAQ</li>
            <li className="mb-4 font-extralight">Contact</li>
          </ul>
        </div>
        <div className="">
          <h4 className="mb-4 text-1xl font-semibold">Download App</h4>
          <p className="mb-4 font-extralight">Save $3 with App New User Only</p>

          <div className="grid gap-3 grid-cols-5">
            <div className="col-span-2">
              <img className="w-23" src={qrCode} alt="" />
            </div>
            <div className="col-span-3">
              <a href="http://">
                <img className="w-33 mb-2.5" src={appstore} alt="" />
              </a>
              <a href="http://">
                <img className="w-33" src={googleplay} alt="" />
              </a>
            </div>
          </div>
      ...
      <p className="text-center text-neutral-500">
        &copy; Copyright Exclusive 2025. All right reserved
      </p>
    </div>
  );
}
